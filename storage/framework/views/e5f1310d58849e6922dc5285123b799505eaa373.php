                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 ">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-2 mt-4">
                                        <div class="text-muted text-center mb-4 mx-lg-3">
                                            ...
                                            <p>Please enter the 4 digit code sent to <span class="fw-semibold"><?php echo e(session('email')?session('email'):''); ?></span></p>
                                        </div>

                                        <form id="verify_account" action="<?php echo e(route('user.verify.email')); ?>" method="POST">

                                            <?php echo $__env->make('includes.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="email" value="<?php echo e(session('email')??session('email')); ?>">
                                            <div class="mb-3">
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0">Didn't receive a code ? <a href="javascript:;" data-href="<?php echo e(route('user.resend.verify',session('email')??session('email'))); ?>"  class="fw-semibold text-primary text-decoration-underline resendcodelk">Resend</a> </p>
                            </div>
  ...
  <?php elseif(session('showReferralModal')): ?>
                              ...
                              <div class="card mt-4">
                                  <div class="card-body p-0">
                                      ...
                                      <div class="p-2 mt-4">
                                          ...
                                          <form id="referralForm" action="<?php echo e(route('user.google-referral-submit')); ?>" method="POST">
                                              ...
                                              <div class="mt-3">
                                                  <a href="<?php echo e(route('user.google-skip-referral')); ?>"  class="btn btn-secondary" >Skip</a>
...
<?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/includes/modals.blade.php ENDPATH**/ ?>
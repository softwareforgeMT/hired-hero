...
<section class="min-h-screen py-12 px-4 md:px-8 relative overflow-hidden" style="background: linear-gradient(135deg, #0f172a 0%, #1a1f3a 100%);">
  ...
  <div class="max-w-4xl mx-auto relative z-10 pt-12">
    ...
    <div class="flex flex-col sm:flex-row gap-4 mb-6">
      <form method="POST" action="<?php echo e(route('placement.create')); ?>" class="flex-1">
        <?php echo csrf_field(); ?>
      ...
      <a href="<?php echo e(route('user.dashboard')); ?>" class="px-10 py-4 bg-gradient-to-br from-slate-800 to-slate-900 text-white font-bold rounded-lg border-2 border-red-500/30 hover:border-red-500/60 hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 flex items-center justify-center gap-3 text-lg">
      ...
      <a href="<?php echo e(route('user.register')); ?>" class="px-10 py-4 bg-gradient-to-br from-slate-800 to-slate-900 text-white font-bold rounded-lg border-2 border-red-500/30 hover:border-red-500/60 hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 flex items-center justify-center gap-3 text-lg">
    ...
    <div class="text-center mb-16">
      <p class="text-gray-300 text-lg">
        <span class="inline-flex items-center gap-2">
          <i class="ri-gift-2-line text-red-400 text-xl"></i>
          <span><strong>Along with 14 days free access</strong> — no credit card required</span>
        </span>
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
      ...
      <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-8 border border-red-500/20 hover:border-red-500/50 hover:shadow-xl hover:shadow-red-500/20 transition-all duration-300 group">
        ...
        <p class="text-gray-400 leading-relaxed">Get matched keywords to pass the ATS system and increase your chances of getting noticed by recruiters.</p>
      </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/front/index.blade.php ENDPATH**/ ?>
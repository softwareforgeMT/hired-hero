...
<?php $__env->startSection('title', 'HiredHeroAI for Individuals | Practice Interviews & Build Confidence'); ?>
<?php $__env->startSection('meta_description', 'Use HiredHeroAI to practice interviews, get feedback on your answers, and build the communication skills you need to feel confident in real job interviews.'); ?>
    ...
    <div class="container" style="padding-top:20px; padding-bottom:70px; max-width:1100px;">
        ...
        <div class="row align-items-center mb-4">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center gap-3 mt-2">
                    <a href="<?php echo e(route('user.register')); ?>" class="btn btn-primary">
            ...
            <div class="col-lg-6 text-center">
                <div class="p-3 p-md-4 rounded-4 shadow-lg bg-dark bg-opacity-25">
                    <img
                        src="<?php echo e(asset('assets/images/bg-auth.jpg')); ?>"
        ...
        <div class="mt-4">
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('user.register')); ?>" class="btn btn-primary btn-lg">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hired-hero\resources\views/front/SEO/platform-individuals.blade.php ENDPATH**/ ?>
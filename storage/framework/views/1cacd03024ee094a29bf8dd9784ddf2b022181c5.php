...
<?php $__env->startSection('title', 'HiredHeroAI Platform Overview | AI Interview & Career Readiness'); ?>
<?php $__env->startSection('meta_description', 'See how the HiredHeroAI platform brings together AI mock interviews, soft skills assessments, resume support, and insights dashboards for organizations and individuals.'); ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <div class="p-3 p-md-4 rounded-4 border border-opacity-25 border-light bg-transparent d-inline-block w-100" style="max-width:480px;">
                        ...
                        <div class="ratio ratio-16x9 rounded-3 overflow-hidden">
                           <img src="<?php echo e(asset('assets/images/landing/UserSide.png')); ?>"
        ...
        <div class="mb-4">
            <div class="p-4 p-md-5 rounded-4 border border-opacity-25 border-primary bg-transparent d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-column flex-sm-row gap-2">
                    ...
                    <a href="<?php echo e($trialUrl ?? '#'); ?>" class="btn btn-outline-light btn-lg px-4">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hired-hero\resources\views/front/SEO/platform-overview.blade.php ENDPATH**/ ?>
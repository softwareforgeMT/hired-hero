...
<div class="wizard-step-content">
    ...
    if ($daysSinceCreated < 14) {
        ...
        <form action="<?php echo e(route('placement.wizard.submit', ['step' => 6])); ?>" method="POST" enctype="multipart/form-data" id="step6Form">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                placeholder="you@example.com" value="<?php echo e(old('email', $profile->email ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-4">
            ...
            <div class="resume-options-tabs mb-4">
                ...
                <label class="resume-option-card">
                    <input type="radio" name="resume_option" value="upload" class="d-none resume-option-input" onchange="switchResumeOption('upload')" <?php if(!$hasExistingResumes): ?> checked <?php endif; ?>>
                    <div class="resume-option-body">
                        <div class="option-icon">
                ...
                <label class="resume-option-card">
                    ...
                    <div class="resume-option-body">
                        ...
                        <div class="option-text">
                            <h5>
                                <?php if($canUseResumeBuilder): ?>
                                Use Resume Builder
                                <?php else: ?>
                                Upgrade Resume Builder
                                <?php endif; ?>
                                <?php if($showFreeTrialBadge): ?>
            ...
            <div class="resume-option-content" id="existing-content" style="display: none;">
                <div class="form-group mb-4">
                    ...
                    <?php if($hasExistingResumes): ?>
                    <div class="existing-resumes-list" id="resumesList">
                        <?php $__currentLoopData = $existingResumes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resume): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="existing-resume-item" data-resume-id="<?php echo e($resume->id); ?>">
                            <input type="radio" name="existing_resume_id" value="<?php echo e($resume->id); ?>" class="d-none resume-radio" onchange="selectResume('<?php echo e($resume->id); ?>', '<?php echo e(route('resume-builder.download', ['resume' => $resume->id])); ?>')">
                                ...
                                <div class="resume-item-content">
                                    <div class="resume-item-left">
                                        ...
                                        <div class="resume-item-info">
                                            <h6 class="resume-item-title"><?php echo e($resume->title ?? 'Untitled Resume'); ?></h6>
                                            <div class="resume-item-meta-row">
                                                <span class="resume-item-template"><?php echo e(ucfirst($resume->template_name ?? 'Professional')); ?></span>
                                                <span class="resume-item-date"><?php echo e($resume->created_at->format('M d, Y')); ?></span>
                                            </div>
                                            <p class="resume-item-person">
                                                <i class="ri-user-line"></i>
                                                <?php echo e($resume->data['personal_info']['full_name'] ?? $resume->data['full_name'] ?? 'N/A'); ?>

                                            </p>
                                        </div>
                                    </div>
                                    <div class="resume-item-actions">
                                        <a href="<?php echo e(route('resume-builder.view', ['resume' => $resume->id])); ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="Preview">
                                            <i class="ri-eye-line"></i> Preview
                                        </a>
                                        <button type="button" class="btn btn-sm btn-outline-danger delete-resume-btn" data-resume-id="<?php echo e($resume->id); ?>" title="Delete permanently">
                    ...
                    <div class="alert alert-info" role="alert">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('resume-builder.pricing')); ?>" class="btn btn-sm btn-info">
            ...
            <div class="resume-option-content" id="upload-content" <?php if(!$hasExistingResumes): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
                <div class="form-group mb-4">
                    <label class="form-label fw-semibold mb-3">
                        Upload Resume <span class="text-danger">*</span>
                    </label>
                    <div class="resume-upload-area <?php $__errorArgs = ['resume'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="resumeUploadArea">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="resume-option-content" id="builder-content" style="display: none;">
                ...
                <div class="builder-active-card">
                    <div class="builder-card-header">
                        ...
                        <h5>Resume Builder Active <?php if($showFreeTrialBadge): ?><span class="badge bg-success text-white ms-2">Free Trial</span><?php endif; ?></h5>
                    </div>
                    <p><?php if($showFreeTrialBadge): ?>You have access to Resume Builder for 14 days. Try it out and create a professional resume!<?php else: ?> You have an active subscription with Resume Builder access. Click below to create or continue building your resume.<?php endif; ?></p>
                    <a href="<?php echo e(route('resume-builder.form')); ?>" class="btn btn-primary w-100 mt-3">
                ...
                <div class="builder-upsell-card">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('resume-builder.pricing')); ?>" class="btn btn-primary w-100">
        ...
        <div class="d-flex justify-content-between align-items-center pt-4 border-top">
            ...
            <div>
                <a href="<?php echo e(route('placement.wizard.step', ['step' => 5])); ?>" class="btn btn-outline-secondary me-2 waves-effect waves-light">
                    Back
                </a>
...
<script>
    ...
    function goToUpgrade(plan) {
        window.location.href = '<?php echo e(route("resume-builder.pricing")); ?>';
    }
    ...
    document.getElementById('step6Form').addEventListener('submit', async function(e) {
        ...
        if (option === 'upload') {
            ...
            e.stopImmediatePropagation();
            window.location.href = '<?php echo e(route("resume-builder.form")); ?>';
            return false;
        }
    });
...
<?php echo $__env->make('placement.wizard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/placement/wizard/step-6.blade.php ENDPATH**/ ?>
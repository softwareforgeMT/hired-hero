...
<div class="wizard-step-content">
    ...
    <div class="upsell-banner mb-5">
        <div class="upsell-banner-content">
            ...
            <a href="<?php echo e(route('front.pricing')); ?>" class="btn btn-sm btn-warning">
    ...
    <form id="step8Form" method="POST" data-step="8">
        ...
        <div class="form-group mb-5">
            ...
            <div class="roles-grid">
                ...
                <?php $__currentLoopData = $suggestedRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="role-card">
                    <div class="role-match-badge"><?php echo e($role['match']); ?>% Match</div>
                    <input type="checkbox" name="selected_roles[]"
                        id="role_<?php echo e(str_replace(' ', '_', strtolower($role['title']))); ?>"
                        value="<?php echo e($role['title']); ?>"
                        class="role-checkbox"
                        <?php echo e(in_array($role['title'], old('selected_roles', $profile?->selected_roles ?? [])) ? 'checked' : ''); ?>>
                    <label for="role_<?php echo e(str_replace(' ', '_', strtolower($role['title']))); ?>" class="role-label">
                        <div class="role-title"><?php echo e($role['title']); ?></div>
        ...
        <div class="d-flex justify-content-between align-items-center pt-4 border-top">
            ...
            <div>
                <a href="<?php echo e(route('placement.wizard.step', ['step' => 7])); ?>" class="btn btn-outline-secondary me-2 waves-effect waves-light">
                    Back
                </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="scraping-status">
                        <p id="statusMessage" class="text-muted mb-3">Initializing job scraper...</p>
                    </div>
...
<script>
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const saveResponse = await fetch('<?php echo e(route("placement.wizard.submit", ["step" => 8])); ?>', {
                method: 'POST',
                headers: {
            ...
            const response = await fetch('<?php echo e(route("placement.scraping.start")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async function pollProgress() {
        try {
            ...
            const response = await fetch('<?php echo e(route("placement.scraping.progress")); ?>', {
                headers: {
                    'Accept': 'application/json',
                    'X-Requested-With': 'XMLHttpRequest'
                }
    ...
    function showCompletedState(data) {
        ...
        document.getElementById('statusMessage').textContent = 'Job scraping completed successfully!' + jobCountText;
    ...
    function goToJobMatches() {
        window.location.href = '<?php echo e(route("placement.jobs.index")); ?>';
    }
...
<?php echo $__env->make('placement.wizard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/placement/wizard/step-8.blade.php ENDPATH**/ ?>
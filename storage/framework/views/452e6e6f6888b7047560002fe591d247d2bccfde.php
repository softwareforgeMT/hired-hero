...
<?php $__env->startSection('title', 'HiredHeroAI for Organizations | Colleges, Workforce, Nonprofits'); ?>
  ...
  <section class="section" id="portal-features">
    <div class="container">
      <div class="row align-items-center gy-4">
        ...
        <div class="col-lg-6">
          <div class="image-container">
            <img src="<?php echo e(asset('assets/images/landing/insights6.png')); ?>"
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hired-hero\resources\views/front/SEO/platform-organizations.blade.php ENDPATH**/ ?>
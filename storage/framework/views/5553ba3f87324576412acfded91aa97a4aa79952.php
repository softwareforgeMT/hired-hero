    ...
    <div class="container">
        <div class="wizard-container">
            ...
            <div class="progress-bar">
                <div class="progress-bar-fill" style="width: <?php echo e($progressPercentage ?? ($step / 8 * 100)); ?>%"></div>
            </div>
            ...
            <div class="step-indicator">
                ...
                ?>
                <?php for($i = 1; $i <= 8; $i++): ?>
                    <div class="step-dot <?php echo e($i === $step ? 'active' : ($i < $step ? 'completed' : '')); ?>" 
                         title="<?php echo e($stepTitles[$i] ?? 'Step ' . $i); ?>">
                        <?php echo e($i); ?>
    ...
    document.querySelectorAll('form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            if (submitBtn) {
                ...
                submitBtn.textContent = '<?php echo e(__("placement.loading")); ?>...';
            }
        });
    });
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/placement/wizard/layout.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Edit Job Application'); ?>
...
<section class="section page__content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="<?php echo e(route('placement.applications.update', $application)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        value="<?php echo e(old('job_title', $application->job_title)); ?>"
                                        required
                                    >
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        value="<?php echo e(old('company_name', $application->company_name)); ?>"
                                        required
                                    >
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        value="<?php echo e(old('job_url', $application->job_url)); ?>"
                                    >
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    >
                                        ...
                                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('status', $application->status) === $key ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        id="applied_at" 
                                        name="applied_at"
                                        value="<?php echo e(old('applied_at', $application->applied_at->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                        id="interview_date" 
                                        name="interview_date"
                                        value="<?php echo e(old('interview_date', $application->interview_date?->format('Y-m-d'))); ?>"
                                    >
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    ><?php echo e(old('interview_notes', $application->interview_notes)); ?></textarea>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Herd-Projects\HiredHero-Job-Match\resources\views/placement/applications/edit.blade.php ENDPATH**/ ?>
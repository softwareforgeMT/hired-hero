    ...
    <div class="container">
        <div class="d-inline-flex">
            ...
            <a class="navbar-brand" href="<?php echo e(route('front.index')); ?>">
                <img src="<?php echo e(asset('assets/images/landing/hiredhero_brain.png')); ?>"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: space-between;">
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('plans') ? 'active' : ''); ?>"
                        href="<?php echo e(route('front.pricing')); ?>">
                        Pricing
                    </a>
                </li>
                ...
                <li class="nav-item dropdown">
                   ...
                   <?php echo e(request()->is('platform-overview')
            ...
            ? 'active' : ''); ?>"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle
        <?php echo e(request()->is('resources/organizations')
            ...
            ? 'active' : ''); ?>"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarResources">
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('resources.organizations')); ?>">
                                For Institutions
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('resources.individuals')); ?>">
                                For Job Seekers
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('jobfairs.index')); ?>">
                                Job Fairs (Canada &amp; US)
                            </a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle
        <?php echo e(request()->is('ai-interview-training-colleges')
            ...
            ? 'active' : ''); ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('user/order*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('user.order.purchased.index')); ?>">
                        Orders
                    </a>
                </li>
                <?php endif; ?>
        ...
        <div class="dropdown ms-sm-3 header-item g2z-front topbar-user">
            <button type="button" class="btn"
                ...
                <span class="d-flex align-items-center">
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo Helpers::image(Auth::user()->photo, 'user/avatar/'); ?>"
                        alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="<?php echo e(route('user.order.purchased.index')); ?>">
                ...
                <?php endif; ?>
                <form id="logout-form"
                    action="<?php echo e(route('user.logout')); ?>"
                    method="POST"
                    style="display:none;">
                    <?php echo csrf_field(); ?>
                </form>
    ...
    <div class="offcanvas-body">
        <div class="mobile-navbar">
            <ul class="list-unstyled mb-0">
                ...
                <li class="nav-item mb-1">
                    <a class="nav-link" href="<?php echo e(route('front.pricing')); ?>">Plans</a>
                </li>
                <li class="nav-item mb-1">
                    <a class="nav-link" href="<?php echo e(route('front.page', \App\Models\Page::find(1)->slug)); ?>">About Us</a>
                </li>
                <li class="nav-item mb-3">
                    <a class="nav-link" href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo e($gs->from_email); ?>&su=Book%20a%20Demo&body=Hello%2C%0A%0AI%20would%20like%20to%20book%20a%20demo.">
                        Book a Demo
                    </a>
                </li>
                ...
                <li class="nav-item mb-1 ps-3">
                    <a class="nav-link" href="<?php echo e(route('resources.organizations')); ?>">
                        For Institutions
                    </a>
                </li>
                <li class="nav-item mb-1 ps-3">
                    <a class="nav-link" href="<?php echo e(route('resources.individuals')); ?>">
                        For Job Seekers
                    </a>
                </li>
                <li class="nav-item mb-1 ps-3">
                    <a class="nav-link" href="<?php echo e(route('jobfairs.index')); ?>">
                        Job Fairs (Canada &amp; US)
                    </a>
                </li>
                <li class="nav-item mb-3 ps-3">
                    <a class="nav-link" href="<?php echo e(route('trends.index')); ?>">
                        Job Trends
                    </a>
                </li>
...
</style><?php /**PATH D:\Herd-Projects\hired-hero\resources\views/front/layouts/navbar.blade.php ENDPATH**/ ?>
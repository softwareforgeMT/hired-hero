            ...
            <div class="col-md-9">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <p class="mb-0 text-muted">Welcome back, <strong>{{ Auth::user()->name }}</strong>!</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Current Subscription:</strong> <span class="badge bg-primary">{{ $planName }}</span></p>
                                <p><strong>Referral Code:</strong> <code>{{ Auth::user()->affiliate_code }}</code></p>
                                @if(Auth::user()->referred_by)
                                    <p><strong>Referred By:</strong> {{ Auth::user()->referred_by }}</p>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <p><strong>Money Earned:</strong> <span class="text-success">${{ number_format($totalAmount ?? 0, 2) }}</span></p>
                                <p><strong>Wallet Balance:</strong> <span class="text-primary">${{ number_format(Auth::user()->wallet, 2) }}</span></p>
                            </div>
                        </div>
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('user.earnings') }}" class="btn btn-outline-success btn-sm">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="stats-card green">
                            <h6>Job Matches</h6>
                            <p class="number">{{ $jobMatchesCount }}</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-card blue">
                            <h6>Applications</h6>
                            <p class="number">{{ $totalApplications }}</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-card orange">
                            <h6>Resumes</h6>
                            <p class="number">{{ $resumeCount }}</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-card red">
                            <h6>Interview Attempts</h6>
                            <p class="number">{{ $totalInterviewAttempts }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    <div class="feature-card-header">
                        ...
                        <div class="feature-description">
                            ...
                            <p>{{ $placementProfileExists ? 'Your job matching profile is active' : 'Create your job matching profile to get started' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-actions mt-3">
                        @if($placementProfileExists)
                            <a href="{{ route('placement.jobs.index') }}" class="btn btn-primary btn-sm">
                                <i class="ri-eye-line me-1"></i>View Job Matches
                            </a>
                        @else
                            <a href="{{ route('placement.start') }}" class="btn btn-primary btn-sm">
                ...
                <div class="feature-card">
                    <div class="feature-card-header">
                        ...
                        <div class="feature-description">
                            <h5>Job Matches</h5>
                            <p>{{ $jobMatchesCount }} matching jobs found for your profile</p>
                        </div>
                    </div>
                    @if($jobMatchesCount > 0)
                        <div class="status-badge active">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; vertical-align: middle; display: inline-block; margin-right: 4px;"><circle cx="12" cy="12" r="10"></circle></svg>{{ $jobMatchesCount }} Match{{ $jobMatchesCount != 1 ? 'es' : '' }}
                        </div>
                        <div class="mt-3">
                            <small class="text-muted d-block mb-2">Recent matches:</small>
                            @foreach($pendingJobMatches as $match)
                ...
                <div class="feature-card">
                    <div class="feature-card-header">
                        ...
                        <div class="feature-description">
                            ...
                            <p>Track {{ $totalApplications }} application{{ $totalApplications != 1 ? 's' : '' }} across all companies</p>
                        </div>
                    </div>
                    ...
                    @endif
                    <div class="feature-actions mt-3">
                        <a href="{{ route('placement.applications.index') }}" class="btn btn-primary btn-sm">
                ...
                <div class="feature-card">
                    <div class="feature-card-header">
                        ...
                        <div class="feature-description">
                            ...
                            <p>Practice interviews and get AI feedback ({{ $totalInterviewAttempts }} attempt{{ $totalInterviewAttempts != 1 ? 's' : '' }})</p>
                        </div>
                    </div>
                    @if($totalInterviewAttempts > 0)
                        <div class="status-badge active">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 14px; height: 14px; vertical-align: middle; display: inline-block; margin-right: 4px;"><polyline points="20 6 9 17 4 12"></polyline></svg>{{ $totalInterviewAttempts }} Completed
                        </div>
                        @if($interviewAttempts->count() > 0)
                            <div class="mt-3">
                                <small class="text-muted d-block mb-2">Recent attempts:</small>
                                @foreach($interviewAttempts->take(2) as $attempt)
                    ...
                    @endif
                    <div class="feature-actions mt-3">
                        <a href="{{ url('/mock/add-job-details') }}" class="btn btn-primary btn-sm">
                ...
                <div class="feature-card">
                    <div class="feature-card-header">
                        ...
                        <div class="feature-description">
                            ...
                            <p>Create and manage professional resumes ({{ $resumeCount }} resume{{ $resumeCount != 1 ? 's' : '' }})</p>
                        </div>
                    </div>
                    @if($resumeCount > 0)
                        <div class="status-badge active">
                            <i class="ri-check-line"></i> {{ $resumeCount }} Resume{{ $resumeCount != 1 ? 's' : '' }}
                        </div>
                    @else
                        <p class="text-muted mb-2">Build your first resume now!</p>
                    @endif
                    <div class="feature-actions mt-3">
                        <a href="{{ route('resume-builder.form') }}" class="btn btn-primary btn-sm">
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-actions mt-3">
                        <a href="{{ route('presentation.create') }}" class="btn btn-primary btn-sm">
                ...
                @if ($gs->is_affilate == 1)
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <img src="{{ URL::asset('assets/images/giftbox.png') }}" alt="" style="width: 50px;">
                            <h5 class="mt-3">Promote {{ $gs->name }}</h5>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('user.earnings') }}" class="btn btn-outline-primary btn-sm">

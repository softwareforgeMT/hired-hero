...
@section('title', 'Digital Career Readiness Platform for Workforce Boards | HiredHeroAI')
@section('meta_description', 'Give jobseekers interview practice, soft skills assessments, and career readiness tools with an AI-powered platform built for workforce boards, employment programs, and nonprofits in Canada and the US.')

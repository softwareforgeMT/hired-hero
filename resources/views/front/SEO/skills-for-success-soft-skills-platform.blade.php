...
@section('title', 'Skills for Success – Soft Skills Assessment Platform | HiredHeroAI')
@section('meta_description', 'Measure and improve communication, problem-solving, and other core Skills for Success with an AI-powered assessment and practice platform for colleges and workforce programs in Canada and the US.')

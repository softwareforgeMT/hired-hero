...
@section('title') Record Your Presentation @endsection
@section('css')
<style>
    #presentation-video {
        border-radius: 10px;
    ...
    <div class="container">
        <div class="d-inline-flex">
            <a class="navbar-brand" href="{{ route('front.index') }}">
                <img src="{!! Helpers::image($gs->logo_dark, 'logo/') !!}" class="card-logo card-logo-dark" alt="logo dark" height="17">
                <img src="{!! Helpers::image($gs->logo_light, 'logo/') !!}" class="card-logo card-logo-light" alt="logo light" height="17">
            </a>
        </div>
    </div>
</nav>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    <video id="presentation-video" autoplay muted loop>
                        <source src="{{ asset('presentations/intro.mp4') }}" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <img id="judges-image" src="{{ asset('presentations/judges.png') }}" style="display:none; width: 100%; border-radius: 10px;">
...
<script>
    ...
    function sendRecording() {
        ...
        $.ajax({
            url: '{{ route("presentation.upload.audio") }}', // Ensure this route is defined in your web.php file
            type: 'POST',
            data: formData,
            headers: {
    ...
    function endPresentation() {
        ...
        const resultsRoute = '{{ route("presentation.feedback") }}';

...
@section('title', 'Job Fairs in Canada & United States')
...
@section('content')
            ...
            <div class="row gy-3 align-items-center">
                ...
                <div class="col-lg-5 text-lg-end">
                    <div class="d-grid gap-2">
                        <a href="{{ route('resources.individuals') }}" class="btn btn-light btn-lg">
    ...
    <section class="hh-fair-section" id="canada">
        <div class="container">
            ...
            <div class="row g-3">
                ...
                {{-- Career Fair Canada (mostly in-person) --}}
                <div class="col-md-6 col-lg-4"
                    ...
                    <div class="hh-fair-card">
                        ...
                        <a href="{{ route('resources.individuals') }}" class="btn btn-sm btn-soft-primary">
                            Prep for Career Fair Canada
                        </a>
                    </div>
                </div>

                {{-- Eventbrite CA (in-person + virtual) --}}
                <div class="col-md-6 col-lg-4"
                     data-fair-card
                     data-country="canada"
                     data-type="both"
                ...
                {{-- DiversityX (Canada/US, mix of formats) --}}
                <div class="col-md-6 col-lg-4"
                     data-fair-card
                     data-country="both"
                     data-type="both"
                ...
                {{-- WorkBC (mix of formats, workforce audience) --}}
                <div class="col-md-6 col-lg-4"
                     data-fair-card
                     data-country="canada"
                     data-type="both"
                ...
                {{-- Tech Talent Canada (virtual & tech specific) --}}
                <div class="col-md-6 col-lg-4"
                     data-fair-card
                     data-country="canada"
                     data-type="virtual"
    ...
    <section class="hh-fair-section" id="united-states">
        <div class="container">
            ...
            <div class="row g-3">
                ...
                {{-- Tech Jobs Fair (global / NA, often virtual) --}}
                <div class="col-md-6 col-lg-4"
                     data-fair-card
                     data-country="both"
                     data-type="both"
        ...
        <div class="container">
            <div class="row gy-3 align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <a href="mailto:{{ $gs->from_email }}?subject=Job%20Fair%20Suggestion&body=Hi%2C%0A%0AI%20would%20like%20to%20suggest%20adding%20this%20job%20fair%20to%20your%20list%3A%0A%0AEvent%20name%3A%0ACity%2C%20Province%2FState%3A%0ADate%28s%29%3A%0AOfficial%20link%3A%0A%0AThanks%21"
    ...
    {{-- Simple frontend filtering logic --}}
    <script>

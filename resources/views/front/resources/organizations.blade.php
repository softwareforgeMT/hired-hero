...
@section('title', 'Resources for Organizations')
...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center gy-3">
                ...
                <div class="col-lg-5 text-lg-end">
                    {{-- Demo booking: send to info@hiredheroai.com --}}
    ...
    <section class="hh-org-section">
        <div class="container">
            ...
            <div class="row g-3">
                {{-- Card 1: Career Services Modernization --}}
                <div class="col-md-4">
                ...
                {{-- Card 2: Outcomes & Reporting Snapshot --}}
                <div class="col-md-4">
                    <div class="hh-org-card">
                        <div class="hh-org-card-header"
                             data-bs-toggle="collapse"

                        ...
                        <div class="col-lg-6 col-md-10 text-center text-md-start mb-4 mb-lg-0">
                            ...
                            <div class="hero-subgroup">
                                ...
                                <div class="d-flex flex-column flex-sm-row align-items-center gap-2 mb-2">
                                    ...
                                    <a href="{{ $trialUrl }}" class="btn btn-outline-light btn-lg px-4" style="border-radius:12px;">
            ...
            <div class="row align-items-center gy-4">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ $trialUrl }}" class="btn btn-primary">
                            Start Mock Interview
                        </a>
                        <a href="{{ route('presentation.create') }}" class="btn btn-success">
        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-md-5 text-center">
                    <img src="{{ asset('assets/images/landing/HappyLady.png') }}"
...
{{-- Our custom Swiper init (now external, no inline JS) --}}
<script src="{{ asset('assets/js/home-swiper.js') }}"></script>
@endsection
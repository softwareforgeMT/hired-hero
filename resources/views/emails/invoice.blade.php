...
<head>
    ...
    <title>Hired Hero Invoice</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h1>Invoice</h1>
            <p>Dear {{ $user->name }},</p>
            <p>Thank you for your purchase. Here are the details of your subscription:</p>
            <ul>
                <li><strong>Subscription Plan:</strong> {{ $plan->name }}</li>
                <li><strong>Amount:</strong> ${{ number_format($order->amount, 2) }}</li>
                {{-- <li><strong>Payment ID:</strong> {{ $order->payment_id }}</li> --}}
                <li><strong>Expires At:</strong> {{ $order->expires_at }}</li>
            </ul>
            <p>If you have any questions, feel free to contact our support team.</p>
            <p>Best regards,</p>
            <p>The Hired Hero Team</p>
        </div>
        ...
        <div class="email-footer">
            ...
            <p>Contact us: <a href="mailto:info@hiredheroai.com">info@hiredheroai.com</a> </p>
        </div>
    </div>
</body>
</html>

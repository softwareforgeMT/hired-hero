...
<section class="section page__content">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('placement.applications.create') }}" class="btn btn-primary">
            ...
            <div class="col-12">
                <div class="d-flex gap-2 flex-wrap">
                    <div class="pipeline-stage">
                        <h5>To Review</h5>
                        <div class="count">{{ $stats['to_review'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Ready</h5>
                        <div class="count">{{ $stats['ready'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Applied</h5>
                        <div class="count">{{ $stats['applied'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Callback</h5>
                        <div class="count">{{ $stats['callback'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Interview</h5>
                        <div class="count">{{ $stats['interview'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Offer</h5>
                        <div class="count">{{ $stats['offer'] }}</div>
                    </div>
                    <div class="pipeline-stage">
                        <h5>Hired</h5>
                        <div class="count">{{ $stats['hired'] }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form id="filterForm" action="{{ route('placement.applications.filter') }}" method="GET" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <select id="statusFilter" name="status" class="form-select">
                            ...
                            <option value="to-review" {{ request('status') === 'to-review' ? 'selected' : '' }}>To Review</option>
                    ...
                    <div class="col-md-5">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('placement.applications.index') }}" class="btn btn-outline-secondary">
                        ...
                        <tbody>
                            @foreach ($applications as $app)
                                <tr>
                                    ...
                                    <td>{{ $app->last_activity_at?->diffForHumans() ?? '—' }}</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('placement.applications.edit', $app) }}" 
                                               class="btn btn-outline-warning" title="Edit">
                                                <i class="ri-edit-line"></i>
                                            </a>
                                            <a href="{{ route('placement.applications.show', $app) }}" 

...
@section('title', 'Your Job Matches')
@section('content')
        ...
        <div class="filter-section">
            ...
            <div class="range-slider-container">
                <input type="range"
                    ...
                    min="0"
                    max="100"
                    value="{{ request('min_match_score', 0) }}"
                    class="range-slider">
                <div class="range-value">
                    <span class="range-label">Minimum</span>
                    <span class="range-number">{{ request('min_match_score', 0) }}%</span>
                </div>
            </div>
        </div>
            ...
            <div class="job-card">
                <div class="job-card-header">
                    ...
                    <div class="job-main-info">
                        ...
                        <div class="company-info">
                            ...
                            <span class="job-source-badge">{{ strtoupper($job->source) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="job-card-footer">
                    ...
                    <button
                        ...
                        data-job-description="{{ htmlspecialchars($job->job_description ?? '', ENT_QUOTES, 'UTF-8') }}"
                        type="button">
                    ...
                    <button
                        ...
                        data-job-title="{{ htmlspecialchars($job->job_title ?? '', ENT_QUOTES, 'UTF-8') }}"
                        data-job-description="{{ htmlspecialchars($job->job_description ?? '', ENT_QUOTES, 'UTF-8') }}"
                        data-company-name="{{ htmlspecialchars($job->company_name ?? '', ENT_QUOTES, 'UTF-8') }}"
                        type="button">
                    ...
                    <button type="button"
                        ...
                        onclick="removeJobMatch({{ $job->id }}, event); event.preventDefault(); event.stopPropagation();">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="modal-footer border-0 py-3">
                ...
                <a href="{{ route('front.pricing') }}" class="btn btn-success">
...
<script>
    ...
    const hasAiTailoredResumeFeature = {{ $hasAiTailoredResumeFeature ? 'true' : 'false'}};
    const hasAiTailoredCoverFeature = {{ $hasAiTailoredCoverFeature ? 'true' : 'false'}};
    const aiTailoredCoverLimit = {{ $aiTailoredCoverLimit }};
        ...
        fetch('{{ route("placement.resumes.generate") }}', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = '{{ route("placement.resume.edit", ["jobId" => ":jobId"]) }}'

...
<div class="resume-builder-form-container">
    ...
    <form action="{{ route('resume-builder.store') }}" method="POST" id="resumeForm">
        @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="full_name" id="full_name" class="form-control @error('full_name') is-invalid @enderror"
                               value="{{ old('full_name', $profile->user->name ?? '') }}" required>
                        @error('full_name')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="professional_title" id="professional_title" class="form-control"
                               value="{{ old('professional_title') }}" placeholder="e.g., Senior Software Engineer">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
            ...
            <div class="templates-grid">
                @foreach($templates as $templateKey => $templateName)
                    <label class="template-card">
                        <input type="radio" name="template" value="{{ $templateKey }}" class="template-radio" required>
        ...
        <div class="form-actions">
            <a href="{{ route('placement.wizard.step', ['step' => 6]) }}" class="btn btn-outline-secondary waves-effect waves-light">

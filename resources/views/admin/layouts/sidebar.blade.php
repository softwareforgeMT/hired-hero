    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
            ...
            <span class="logo-lg adm-top-logo">
                <img src="{!! Helpers::image($gs->logo_dark, 'logo/') !!}" alt="" height="" width="100%">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="{{ route('admin.dashboard') }}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ asset('logo/'.$gs->logo_dark) }}" alt="Logo" width="100%">
            </span>
            <span class="logo-lg adm-top-logo">
                <img src="{{ asset('logo/'.$gs->logo_light) }}" alt="Logo" width="100%">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.placements.index') }}" >
                        <i class="ri-briefcase-line"></i> <span>Placement Profiles</span>
                    </a>                    
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.subscriptions.index') }}" >
                        <i class="ri-file-list-line"></i> <span>Subscriptions</span>
                    </a>                    
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.promo-codes.index') }}" >
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.custompage.index') }}" >
                ...
                @if($gs->dev_check==1)
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.social-login') }}" >
